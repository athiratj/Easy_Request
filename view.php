...
$sql="SELECT * from request where no ='$i' ";
$result = mysqli_query($conn,$sql);
$array = mysqli_fetch_assoc($result);
$_SESSION['arr']=$array;
echo "<form method='post'action='send.php'> <td><input type='submit'  value='CONFIRM' name='$i'/></td></form>";
}
$i++;
}
?>
...
<div><div class="container emp-profile">
          <form method="post">
              <div class="row">
                  ...
                  <div class="col-md-2">
                  <b id="logout"><a href="rva.php">BACK</a></b>                 </div>
              </div>
